package com.nawoori.android.handmemoex;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //그림판에 들어가는 프레임 레이아웃
        layout = (FrameLayout) findViewById(R.id.dLayout);
        //색상선택
        ...
        //2. 새로 생성된 보드를 화면에 세팅한다.
        //레이아웃에 그림을 그릴 수 있는 공간 생성
    ...
    * 사용하지 않은 브러쉬는 그냥 버려진다.*
    ...
    class Board extends View {
        ...
        //브로쉬의 속성값 변경 여부를 판단하기 위한 플래그 > 브러쉬의 속성값이 바뀌면 path를 다시 생성한다.
        ...
        public void setPaint() {
            //Paint의 기본속성만 적용해 두고, color와 두께는 Brush에서 가져다가 그린다.
            paint = new Paint();
        ...
        protected void onDraw(Canvas canvas) {
            ...
            for (Brush brush : brushes) {
                ...
                //속성값이 반영된 Paint와 Path를 화면에 그려준다.
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            switch (event.getAction()){
                //터치가 시작되면 Path를 생성하고 현재 지정된 비러쉬와 함께 저장소에 담아둔다.
            ...
            // 화면을 갱신해서 위에서 그린 Path를 반영해준다.
            invalidate();
            //리턴 false 일경우 touch 이벤트를 연속해서 발생시키지 않는다.
